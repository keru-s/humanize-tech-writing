...
Skill 使用 plain language，优先普通词、具体动词和项目已有术语。
...
```text
把 docs/design.md 里明显的 AI 生造词改成工程师正常会写的表达。保留技术术语、事实和 MUST/SHOULD/MAY 的强弱语义。
```
...
原项目面向通用中文写作。本 fork 从 2.0.0 起转为技术写作专项 Skill；2.1.0 进一步改成 **语义安全 + 文档类型感知 + 最小编辑** 的结构，不再维护固定数量的“AI 模式分类”。
